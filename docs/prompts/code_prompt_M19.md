...
docs/SPECIFICATION_M19_AdvancedPhysics.md

docs/IMPLEMENTATION_PLAN_M19_AdvancedPhysics.md

Task: Implement Milestone 19: Advanced Physics Mechanics (Motors & Conveyors). Execute the phased steps outlined in the implementation plan.
